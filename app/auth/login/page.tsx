...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-indigo-900/20 blur-[100px] rounded-full" />
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">مرحباً بك مجدداً في أكاديمية دوراتي</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-4 premium-gradient rounded-2xl text-white font-bold text-lg shadow-lg shadow-purple-900/30 hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-10 text-center text-slate-400">
          ليس لديك حساب؟{" "}
          <Link href="/auth/register" className="text-purple-400 font-bold hover:underline inline-flex items-center gap-1 group">
            إنشاء حساب جديد
